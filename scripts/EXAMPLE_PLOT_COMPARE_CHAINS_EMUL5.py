...
g.triangle_plot(
  ...
  shaded=False,
  legend_labels=[
    'Cosmic Shear, Hybrid-emul (baseline analytical-syren w/o corrections), MH',
    '3x2pt, Hybrid-emul (baseline analytical-syren w/o corrections), MH',
  ],
...
g.export(os.path.join(chaindir,"example_compare_chains_emul5.pdf"))