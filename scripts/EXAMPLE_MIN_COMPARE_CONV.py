...
rt = os.environ['ROOTDIR']+"/projects/lsst_y1/chains/EXAMPLE_EMUL_MIN_TEST_CONV"
...
plt.plot(data[1:sz-1,0], 
         ...
         color=colors[0], 
         label="$\\Lambda$CDM, LSST-Y1 Cosmic Shear")
...
plt.savefig(os.environ['ROOTDIR']+
            "/projects/lsst_y1/chains/EXAMPLE_PLOT_MIN_COMPARE_CONV.pdf", 
            bbox_inches='tight')