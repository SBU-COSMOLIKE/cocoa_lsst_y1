...
# ------------------------------------------------------------------------------
root = os.environ['ROOTDIR'] + "/projects/lsst_y1/chains/EXAMPLE_EMUL_PROFILE1."
params = ['As_1e9', 'ns', 'omegab', 'omegam', 'H0', 'LSST_A1_1', 'LSST_A1_2' ]
latex  = ["$10^{9} A_\\mathrm{s}$", "$n_\\mathrm{s}$", 
          "$\\Omega_\\mathrm{b}$", "$\\Omega_\\mathrm{c}$", 
          "$H_0$", "$A_\\mathrm{1-IA,LSST}^1$", "$A_\\mathrm{1-IA,LSST}^2$" ]
# ------------------------------------------------------------------------------
for i in range(7):
...
plt.savefig(os.environ['ROOTDIR'] + "/projects/lsst_y1/chains/EXAMPLE_PLOT_PROFILE1")