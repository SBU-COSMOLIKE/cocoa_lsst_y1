...
class _cosmolike_prototype_base(DataSetLikelihood):
      ...
      if self.cola_emu_mode == "LCDM":
        ...
        if self.cola_precision == 1:
            if self.num_refs == 25:
                ...
                print("[nonlinear] Using Default Precision LambdaCDM PCE emulator with 100 anchors")
        
                from COLA_Emulators.PCE.pce_lcdm_default_100 import emu_cons_proto as emu_lcdm_default_pce 
                self.emulator = emu_lcdm_default_pce()
  ...
  #pce_wcdm_high  pce_wcdm_default
          ...
          from COLA_Emulators.PCE.pce_wcdm_default_25 import emu_cons_proto2 as emu_wcdm_default_pce 
          ...
          self.emulator = emu_wcdm_default_pce()
            ...
            if self.cola_precision == 2: 
                if  self.non_linear_emul == 6 :  

                    print("[nonlinear] Using High Precision wCDM NEURAL PCE emulator with 100 anchors")
                    
                    from COLA_Emulators.PCE.NN_pce_wcdm_high_100 import emu_cons_proto2 as emu_wcdm_default_pce                 
        ...
        elif self.num_refs == 500:
          print("[nonlinear] Using wCDM NEURAL PCE with 500 anchors ")
          from COLA_Emulators.PCE.NN_pce_wcdm_def_500 import emu_cons_proto2 as emu_wcdm_default_pce 
