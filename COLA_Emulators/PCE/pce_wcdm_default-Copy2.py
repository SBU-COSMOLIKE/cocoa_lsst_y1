...
class emu_cons_proto2(object):
    ...
    def __init__(self):
        ...
        for Init in tqdm(range(35)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE4/PCE_WCDM_z'+str(redshift)+'_A.txt') )
            self.b_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE4/PCE_WCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE4/PCE_WCDM_z'+str(redshift)+'_WTRANS.txt') )
        ...
        for Init in tqdm(range(5)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE4/PCE_WCDM_z'+str(redshift)+'_A.txt') )
            self.b_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE4/PCE_WCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE4/PCE_WCDM_z'+str(redshift)+'_WTRANS.txt') )
    ...
    def get_boost_cocoa(self, cosmo_dict ):
        ...
        return self.ks_cola,self.ks_cola[:256], cosmos_34,cosmos_6
