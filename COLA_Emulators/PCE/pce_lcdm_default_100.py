...
class emu_cons_proto(object):
    ...
    def __init__(self):
        ...
        self.max_values = np.array([13,13,13,13,13])
        ...
        for Init in tqdm(range(34)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_100/PCE_LCDM_z'+str(redshift)+'_A.txt') )
            self.b_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_100/PCE_LCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_100/PCE_LCDM_z'+str(redshift)+'_WTRANS.txt') )
        ...
        for Init in tqdm(range(6)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_100/PCE_LCDM_z'+str(redshift)+'_A.txt') )
            self.b_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_100/PCE_LCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_100/PCE_LCDM_z'+str(redshift)+'_WTRANS.txt') )
