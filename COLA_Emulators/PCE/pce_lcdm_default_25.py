    ...
    def __init__(self):
        ...
        for Init in tqdm(range(34)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_HIGH/PCE_LCDM_z'+str(redshift)+'_A.txt') )
            self.b_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_HIGH/PCE_LCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_LCDM_HIGH/PCE_LCDM_z'+str(redshift)+'_WTRANS.txt') )
