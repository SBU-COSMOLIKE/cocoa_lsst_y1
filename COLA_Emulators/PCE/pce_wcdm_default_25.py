...
class emu_cons_proto2(object):
    ...
    def __init__(self):
        ...
        for Init in tqdm(range(35)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE_25/PCE_WCDM_z'+str(redshift)+'_A.txt') )
            self.b_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE_25/PCE_WCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_34.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE_25/PCE_WCDM_z'+str(redshift)+'_WTRANS.txt') )
        ...
        for Init in tqdm(range(5)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE_25/PCE_WCDM_z'+str(redshift)+'_A.txt') )
            self.b_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE_25/PCE_WCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_6.append(np.loadtxt(f'{current_dir}/PCE_COLA_wCDM_CB_MINE_25/PCE_WCDM_z'+str(redshift)+'_WTRANS.txt') )
    ...
    def get_boost_cocoa(self, cosmo_dict,log10k_interp_2D ):
        ...
        num_of_points= 70#30ou 60ou 50 ou 70 
        num_of_points2= 70   #30 ou60 ou 50 ou 70
