...
class emu_cons_proto2(object):
    ...
    def __init__(self):
        ...
        self.filtered_combs = pce_.filter_q0_norm(self.combinations, threshold=6) #5         
        ...
        for Init in tqdm(range(35)):
           ...
           # print('redshift=',redshift)
            self.A_34.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_LCDM_z'+str(redshift)+'_A.txt') )
            self.b_34.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_LCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_34.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_LCDM_z'+str(redshift)+'_WTRANS.txt') )
        ...
        for Init in tqdm(range(5)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_6.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_LCDM_z'+str(redshift)+'_A.txt') )
            self.b_6.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_LCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_6.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_LCDM_z'+str(redshift)+'_WTRANS.txt') )
        ...
        for Init in tqdm(range(35)):
            ...
            layer1_weight_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer1_weight.txt'))
            layer1_bias_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer1_bias.txt'))
            holdup=np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer1_gamma.txt')
            custom_layer1_gamma_35.append( holdup)
            custom_layer1_beta_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer1_beta.txt'))
            
            layer2_weight_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer2_weight.txt'))
            layer2_bias_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer2_bias.txt'))
            
            holdup = np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer2_gamma.txt')            
            custom_layer2_gamma_35.append(holdup )
            custom_layer2_beta_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer2_beta.txt'))
            
            layer3_weight_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer3_weight.txt'))
            layer3_bias_35.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer3_bias.txt'))
        ...
        for Init in tqdm(range(5)):
            ...
            layer1_weight_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer1_weight.txt'))
            layer1_bias_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer1_bias.txt'))
            
            holdup = np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer1_gamma.txt')
            custom_layer1_gamma_5.append(holdup )
            custom_layer1_beta_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer1_beta.txt'))
            
            layer2_weight_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer2_weight.txt'))
            layer2_bias_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer2_bias.txt'))
           
            holdup =np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer2_gamma.txt')
            custom_layer2_gamma_5.append( holdup)
            custom_layer2_beta_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_custom_layer2_beta.txt'))
            
            layer3_weight_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer3_weight.txt'))
            layer3_bias_5.append(np.loadtxt(f'{current_dir}/wCDM_PNN_HIGH_100/PCE_wCDM_z'+str(redshift)+'_layer3_bias.txt'))
    ...
    def get_boost_cocoa(self, cosmo_dict,log10k_interp_2D ):
        ...
        num_of_points= 20#30ou 60ou 50 ou 70 
        num_of_points2=20  #30 ou60 ou 50 ou 70
