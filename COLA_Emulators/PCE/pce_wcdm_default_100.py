    ...
    def __init__(self):
        ...
        for Init in tqdm(range(35)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_34.append(np.loadtxt(f'{current_dir}/PCE_WCDM_100/PCE_WCDM_z'+str(redshift)+'_A.txt') )
            self.b_34.append(np.loadtxt(f'{current_dir}/PCE_WCDM_100/PCE_WCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_34.append(np.loadtxt(f'{current_dir}/PCE_WCDM_100/PCE_WCDM_z'+str(redshift)+'_WTRANS.txt') )
        ...
        for Init in tqdm(range(5)):
           ...
           # print('redshift=',redshift)
            ...
            self.A_6.append(np.loadtxt(f'{current_dir}/PCE_WCDM_100/PCE_WCDM_z'+str(redshift)+'_A.txt') )
            self.b_6.append(np.loadtxt(f'{current_dir}/PCE_WCDM_100/PCE_WCDM_z'+str(redshift)+'_b.txt') )
            self.Wtrans_6.append(np.loadtxt(f'{current_dir}/PCE_WCDM_100/PCE_WCDM_z'+str(redshift)+'_WTRANS.txt') )
