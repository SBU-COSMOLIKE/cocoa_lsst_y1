...
class emu_cons_proto(object):
    ...
    def __init__(self):
        ...
        layer1_weight_35=[]
        layer1_bias_35=[]
        custom_layer1_alpha_35=[]
        custom_layer1_gamma_35=[]
        custom_layer1_teta_35=[]
        layer2_weight_35=[]
        layer2_bias_35=[]
        custom_layer2_alpha_35=[]
        custom_layer2_gamma_35=[]
        custom_layer2_teta_35=[]
        layer3_weight_35=[]
        layer3_bias_35=[]
        ...
        for Init in tqdm(range(35)):
            ...
            layer1_weight_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer1_weight.txt'))
            layer1_bias_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer1_bias.txt'))



            holdup =   np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer1_alpha.txt')  
            custom_layer1_alpha_35.append(holdup )
            holdup=np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer1_gamma.txt')            
            custom_layer1_gamma_35.append( holdup)
            custom_layer1_teta_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer1_teta.txt'))



            
            layer2_weight_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer2_weight.txt'))
            layer2_bias_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer2_bias.txt'))


            
            holdup =   np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer2_alpha.txt')  
            custom_layer2_alpha_35.append(holdup )
            
            holdup = np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer2_gamma.txt')            
            custom_layer2_gamma_35.append(holdup )
            custom_layer2_teta_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer2_teta.txt'))




            
            layer3_weight_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer3_weight.txt'))
            layer3_bias_35.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer3_bias.txt'))
        ...
        self.custom_layer1_alpha_35=np.array(custom_layer1_alpha_35)
        self.custom_layer1_gamma_35=np.array(custom_layer1_gamma_35)
        self.custom_layer1_teta_35=np.array(custom_layer1_teta_35)
        self.layer2_weight_35=np.array(layer2_weight_35)
        self.layer2_bias_35=np.array(layer2_bias_35)
        self.custom_layer2_alpha_35=np.array(custom_layer2_alpha_35)        
        self.custom_layer2_gamma_35=np.array(custom_layer2_gamma_35)
        self.custom_layer2_teta_35=np.array(custom_layer2_teta_35)
        ...
        custom_layer1_alpha_5=[]
        custom_layer1_gamma_5=[]
        custom_layer1_teta_5=[]
        
        layer2_weight_5=[]
        layer2_bias_5=[]
        
        custom_layer2_alpha_5=[]
        custom_layer2_gamma_5=[]
        custom_layer2_teta_5=[]
        ...
        for Init in tqdm(range(5)):
            ...
            layer1_weight_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer1_weight.txt'))
            layer1_bias_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer1_bias.txt'))



            holdup =   np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer1_alpha.txt')  
            custom_layer1_alpha_5.append(holdup )           
            holdup = np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer1_gamma.txt')
            custom_layer1_gamma_5.append(holdup )
            custom_layer1_teta_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer1_teta.txt'))
            
            layer2_weight_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer2_weight.txt'))
            layer2_bias_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer2_bias.txt'))


            holdup =   np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer2_alpha.txt')  
            custom_layer2_alpha_5.append(holdup )    
            holdup =np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer2_gamma.txt')
            custom_layer2_gamma_5.append( holdup)
            custom_layer2_teta_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_custom_layer2_teta.txt'))
            
            layer3_weight_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer3_weight.txt'))
            layer3_bias_5.append(np.loadtxt(f'{current_dir}/LCDM_PNN_HIGH/PCE_LCDM_z'+str(redshift)+'_layer3_bias.txt'))
        ...
        self.custom_layer1_alpha_5=np.array(custom_layer1_alpha_5)
        self.custom_layer1_gamma_5=np.array(custom_layer1_gamma_5)
        self.custom_layer1_teta_5=np.array(custom_layer1_teta_5)
        
        self.layer2_weight_5=np.array(layer2_weight_5)
        self.layer2_bias_5=np.array(layer2_bias_5)   
        
        self.custom_layer2_alpha_5=np.array(custom_layer2_alpha_5)       
        self.custom_layer2_gamma_5=np.array(custom_layer2_gamma_5)
        self.custom_layer2_teta_5=np.array(custom_layer2_teta_5)
    ...
    def get_neural_pce_correction(self,pce_expansion):
        def activation(x, alpha, teta, gamma):
            def sigmoid(x):
                return 1 / (1 + np.exp(-x))
            return (alpha * x + sigmoid(teta * x) * (1 - alpha) * x + (1 - teta) / sigmoid(-gamma * x))
        ...
        for i in (range(35)):  
            ...
            x = activation( x,self.custom_layer1_alpha_35[i],self.custom_layer1_teta_35[i],self.custom_layer1_gamma_35[i])
            
            x = x@self.layer2_weight_35[i].T + self.layer2_bias_35[i]
            x = activation( x,self.custom_layer2_alpha_35[i],self.custom_layer2_teta_35[i],self.custom_layer2_gamma_35[i])
        ...
        for i in (range(5)):  
            ...
            x = activation( x,self.custom_layer1_alpha_5[i],self.custom_layer1_teta_5[i],self.custom_layer1_gamma_5[i])
            
            x = x@self.layer2_weight_5[i].T + self.layer2_bias_5[i]
            x = activation( x,self.custom_layer2_alpha_5[i],self.custom_layer2_teta_5[i],self.custom_layer2_gamma_5[i])
